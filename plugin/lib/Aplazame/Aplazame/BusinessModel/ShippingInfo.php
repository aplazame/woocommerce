...
class Aplazame_Aplazame_BusinessModel_ShippingInfo {
	...
	public static function createFromOrder( WC_Order $order ) {
		...
		$shippingInfo->city             = WC_Aplazame::method_or_attribute( $order, 'get_shipping_city', 'shipping_city' );
		$shippingInfo->state            = WC_Aplazame::method_or_attribute( $order, 'get_shipping_state', 'shipping_state' );
		$shippingInfo->country          = WC_Aplazame::method_or_attribute( $order, 'get_shipping_country', 'shipping_country' );
		$shippingInfo->postcode         = WC_Aplazame::method_or_attribute( $order, 'get_shipping_postcode', 'shipping_postcode' );

...
<div
	<?php if ( 'v3' === $aplazame->settings['cart_widget_ver'] ) : ?>
		data-aplazame-widget-instalments=""
		data-view="cart"
	<?php elseif ( 'v4' === $aplazame->settings['cart_widget_ver'] ) : ?>
		data-aplazame-widget-instalments="v4"
		data-type="cart"
		data-option-max-amount-desired="<?php echo esc_attr( 'yes' === $aplazame->settings['cart_widget_max_desired'] ? 'true' : 'false' ); ?>"

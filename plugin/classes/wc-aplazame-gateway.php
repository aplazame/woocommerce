	...
	public function init_form_fields() {
		$this->form_fields = array(
			...
			'product_widget_primary_color'    => array(
				...
				'description' => __( 'Primary color hexadecimal code for product widget (only v4/v5)', 'aplazame' ),
			...
			'cart_widget_primary_color'       => array(
				...
				'class'       => 'colorpick',
				'title'       => __( 'Primary color', 'aplazame' ),
				'description' => __( 'Primary color hexadecimal code for cart widget (only v4/v5)', 'aplazame' ),
